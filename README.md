...
**VirusTotal Scan:** SmartScreen flags the installer, so [here's](https://www.virustotal.com/gui/file-analysis/MzI4MzAyNDgyMjM1YmUxYjU2NDAzNzgwZjVmNzcxZGU6MTc2NTMyMzM2NQ==) a scan of the file to prove it's safe.
